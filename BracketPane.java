...
public class BracketPane extends BorderPane {
        ...
        public void clear(){
        	System.out.println("Clearing: "+displayedSubtree);
            clearSubtree(displayedSubtree);
        }

        //Chris - used to fix a bug with autodefaulting to viewing the full pane when clicking clear twice
        public void updateDisplayedSubtree(int a)
        {
        	this.displayedSubtree=a;
        }
        /**
        ...
        //Chris - Included this to fix a bug where a user would click clear twice and if would auto default to sending them back to the fullpane view
        ...
        //Chris
        public Pane getPane(int a)
        {	if(a==7||a==0)
        	return this.getFullPane();
        else
        	return roots.get(a-3); 
        }
        ...
        {
        	return this.displayedSubtree;
        }
        public void setGUI(MarchMadnessGUI g)
        {
        	this.gui=g;
        }
        /**
        ...
        public BracketPane(Bracket currentBracket,MarchMadnessGUI g) {
        	...
        	this.gui=g;
            	...
            	System.out.println("g.getlast "+this.displayedSubtree);
                ...
                for (StackPane t : buttons) {
                        ...
                        t.setOnMouseClicked(mouseEvent -> {
                                ...
                                //displayedSubtree=buttons.indexOf(t)+3;
                                if(gui!=null)
        ...
        /**
         * The BracketNode model for the Graphical  of the "Bracket"
         */
