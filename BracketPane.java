...
public class BracketPane extends BorderPane {
    ...
    private EventHandler<MouseEvent> clicked = mouseEvent -> {
        ...
        } else {//added by matt 5/7, shows the teams info if you right click
    ...
    public BracketPane(Bracket currentBracket) {
        ...
        //Buttons that guide us to the brackets
    ...
    public BracketPane(Bracket currentBracket, Bracket simulatedBracket) {
        ...
        public void clearSubtree(int position) { currentBracket.resetSubtree(position); }
    ...
    public Pane createFinalFour() {
        ...
        private class BracketNode extends Pane {
            ...
            public void setColor(Color c) { this.name.setTextFill(c); }//chris
